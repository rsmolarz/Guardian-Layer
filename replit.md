...
*   **OpenClaw Monitor:** AI contract monitoring for risk analysis and compliance, plus UI Health Monitor (6 services — Web UI, Contract Analysis API, AI Clause Scanner, Document Processing Pipeline, Notification Service, Compliance Reporting Engine — with uptime/response time/error rate/health checks/P95/P99 metrics, service status filtering, and recent incidents log).
