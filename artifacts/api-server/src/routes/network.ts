...
router.get("/network/vpn-zerotrust", async (_req, res): Promise<void> => {
  try {
    ...
    const sessions = [
      {
        id: "VPN-001", user: "jdoe", email: "jdoe@corp.com", department: "Finance",
        hostname: "WS-FINANCE-04", publicIp: "73.162.45.89", assignedIp: "10.8.0.12",
        vpnStatus: "connected", vpnProtocol: "WireGuard", vpnServer: "us-east-1",
      ...
      {
        id: "VPN-002", user: "asmith", email: "asmith@corp.com", department: "Sales",
        hostname: "LAPTOP-SALES-12", publicIp: "98.207.12.34", assignedIp: "10.8.0.15",
        vpnStatus: "connected", vpnProtocol: "WireGuard", vpnServer: "us-west-2",
      ...
      {
        id: "VPN-003", user: "ceo", email: "ceo@corp.com", department: "Executive",
        hostname: "LAPTOP-EXEC-03", publicIp: "212.58.244.71", assignedIp: "10.8.0.3",
        vpnStatus: "connected", vpnProtocol: "IKEv2", vpnServer: "eu-west-1",
      ...
      {
        id: "VPN-004", user: "mchen", email: "mchen@corp.com", department: "Engineering",
        hostname: "WS-DEVOPS-07", publicIp: "10.0.0.45", assignedIp: "10.8.0.7",
        vpnStatus: "connected", vpnProtocol: "WireGuard", vpnServer: "us-east-1",
      ...
      {
        id: "VPN-005", user: "contractor_01", email: "ext@partner.com", department: "Contractor",
        hostname: "EXT-LAPTOP-01", publicIp: "185.234.72.19", assignedIp: "10.8.0.99",
        vpnStatus: "disconnected", vpnProtocol: "OpenVPN", vpnServer: "us-east-1",
        ...
        policyViolations: [
          ...
          { policy: "Session Timeout", status: "failed", detail: "Session expired 20 hours ago" },
        ],
