...
const JARGON_DICTIONARY: Record<string, string> = {
  ...
  "VPN": "Virtual Private Network — creates an encrypted tunnel for your internet traffic. GuardianLayer uses Tailscale, a modern mesh VPN built on WireGuard.",
  "Tailscale": "A modern mesh VPN built on WireGuard that creates secure, peer-to-peer connections between your devices without a central gateway.",
  "DERP": "Designated Encrypted Relay for Packets — Tailscale's relay servers that help devices connect when direct peer-to-peer isn't possible.",
  "Tailnet": "Your private Tailscale network — all your connected devices form a single secure mesh called a tailnet.",
  "ACL": "Access Control List — rules that define which devices and users can access which resources on your Tailscale network.",
